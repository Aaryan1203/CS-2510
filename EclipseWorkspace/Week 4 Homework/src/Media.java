...
//represent an abstract class of a Media
abstract class AMedia implements IMedia {
   ...
   *  this.isCaptionAvailble(String) ... boolean
   *  this.format() ... String
   * Methods of Fields:
...
//examples of Media and the tests
class ExamplesMedia {
  ...
  IMedia spongebobEpTen = new TVEpisode("I'm Ready", "SpongeBob SquarePants", 1, 10, 
      new ConsLoString("English", new ConsLoString("Spanish", 
          new ConsLoString("Dutch", new MtLoString()))));
  ...
  ILoString languagesThree = new ConsLoString("English", 
      new ConsLoString("French", new ConsLoString("Spanish", new MtLoString())));
  
  ILoString languagesTwo = new ConsLoString("English", 
      new ConsLoString("French", new MtLoString()));
  ...
  //tests the isCaptionAvailble method
  ...
  //tests the checkCaption method
  boolean testCaption(Tester t) {
    return t.checkExpect(this.languagesThree.checkCaption("Spanish"), true)
        && t.checkExpect(this.languagesTwo.checkCaption("Spanish"), false);
  }
}
