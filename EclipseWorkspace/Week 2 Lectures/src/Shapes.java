...
interface IShape {
  //computer the area of this IShape
  double area();
  //computer the distance to 0 of this IShape
  double distToOrigin();
...
class Circle implements IShape {
  ...
  //computer the distance to 0 of this circle
  public double distToOrigin() {
    return this.center.distToOrigin();
  }
...
class Square implements IShape {
   ...
   */
  //computers the area of this square  
  public double area() {
    return Math.pow(this.size, 2);
  }

  //computer distance to 0 of the square
  public double distToOrigin() {
...
*/
  ...
  //return distance to 0 of this combo
  public double distToOrigin() {
